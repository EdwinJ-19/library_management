...
$data_connection = new mysqli("localhost","root","","library_system");
...
$tmp_name = $_FILES['image']['tmp_name']; // Corrected here
    ...
    $result = mysqli_query($data_connection, $sql);
...
$result_1 = $data_connection ->query($view);

//delete operations
// if($_SESSION['$book_name']){
//     $b_id = $_SESSION['book_name'];

//     $sql = "DELETE FROM book_list WHERE book_name = $b_id";

//     $result2 = mysqli_query($data_connection, $sql);
//     if($result2){
...
// $sql2 = "DELETE FROM book_list WHERE book_name = '{$_GET['book_name']}'";
// if($db->query($sql)){
...
<head>
    ...
    <title>Update/Remove Books</title>
    <!-- title icon -->
...
<body>
    ...
    <div class="text-center">
        <h1>Update or Remove Books from the list</h1>
    </div>
    ...
    <div class="d-flex justify-content-center">
        ...
        <table class="table-primary text-center" border="1px">
            <tr>
                ...
                <th style="padding:1rem; font-size:1rem;">Update</th>
            ...
            <tr>
                ...
                <td style="padding:1rem;"><a href="../api/update.php" class="btn btn-info">Update</a></td>
                <form action="../api/delete.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $info['book_id'];?>">
